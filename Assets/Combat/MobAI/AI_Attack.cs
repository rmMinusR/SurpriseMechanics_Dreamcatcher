...
public class AI_Attack : StateMachineBehaviour
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        if (attackPrototype != null)
        {
            ...
            GameObject o = Instantiate(attackPrototype, animator.gameObject.transform);
            o.transform.rotation = animator.gameObject.transform.rotation * o.transform.rotation;
